...
const CollapseCard = ({buttonText , FAQDetails,id}) => {
  return (
    <div id="collapse-Card">
      <p className="mb-0">
        <a className="btn btn-dark d-block text-start clicker-button" data-bs-toggle="collapse" href={`#${id}`} role="button" aria-expanded="false" aria-controls="collapseExample">
          {buttonText}
        </a>
      </p>
